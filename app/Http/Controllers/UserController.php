...
class UserController extends Controller
{
    ...
    public function approve($slug)
    {
        ...
        $user->status = 'active';
        $user->save();
        return redirect('/users/user-detail/' . $slug)->with('status', 'User Berhasil Diaktivasi');
    }
    ...
    public function restore($slug)
    {
        ...
        return redirect()->route('users.index')->with('status', 'User Berhasil Diaktivasi Kembali');
    }
}
